        ...
        <body>
            ...
            <table class="tg">
              <tr>
                ...
                <th class="tg-3wr7">Member Type<br></th>
              </tr>
              @foreach ($customer as $data)
              <tr>
                <td class="tg-rv4w" width="20%">{{$data->nama_mahasiswa}}</td>
                <td class="tg-rv4w" width="40%">{{ $data->alamat}}</td>
                <td class="tg-rv4w" width="30%">{{$data->TTL}}</td>
                <td class="tg-rv4w" width="30%">{{$data->agama}}</td>
              </tr>
              @endforeach
            </table>
        </body>
