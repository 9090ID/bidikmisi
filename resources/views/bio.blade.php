...
<html lang="en">
  <head>
    ...
    <link href="{{asset('/style.css')}}" rel="stylesheet">diluar
...
-->
 ...
 <footer class="container-fluid text-center bg-lightgray">
   ...
   <script src="{{asset('js/jquery.min.js')}}"></script>
    ...
    <script src="{{asset('bio/jquery.smooth-scroll.min.js')}}"></script>
    <script src="{{asset('bio/jquery.mixitup.min.js')}}"></script>
    <script src="{{asset('bio/jquery.easing.1.3.js')}}"></script>
    <script src="{{asset('bio/modernizr.js')}}"></script>
    <script src="{{asset('bio/jquery.fancybox.pack.js')}}"></script>
    <script src="{{asset('bio/custom.js')}}"></script>
